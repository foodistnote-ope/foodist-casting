...
export const DEFAULT_TAGS: Tag[] = [
    ...
    { id: 'tag_w020', name: '講師・レッスン', category: '対応可能業務', sortOrder: 11, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    ...
    { id: 'tag_d037', name: '日常ごはん', category: '得意な料理ジャンル', sortOrder: 9, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d015', name: '和食', category: '得意な料理ジャンル', sortOrder: 10, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d016', name: '洋食', category: '得意な料理ジャンル', sortOrder: 11, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d017', name: '中華', category: '得意な料理ジャンル', sortOrder: 12, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d018', name: '韓国料理', category: '得意な料理ジャンル', sortOrder: 13, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d019', name: 'エスニック', category: '得意な料理ジャンル', sortOrder: 14, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d034', name: 'イタリアン', category: '得意な料理ジャンル', sortOrder: 15, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d035', name: 'フレンチ', category: '得意な料理ジャンル', sortOrder: 16, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d008', name: 'パン', category: '得意な料理ジャンル', sortOrder: 17, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d009', name: 'お菓子', category: '得意な料理ジャンル', sortOrder: 18, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d013', name: '発酵', category: '得意な料理ジャンル', sortOrder: 19, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d014', name: '米粉', category: '得意な料理ジャンル', sortOrder: 20, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d020', name: 'ダイエット', category: '得意な料理ジャンル', sortOrder: 21, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d021', name: '腸活', category: '得意な料理ジャンル', sortOrder: 22, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d022', name: '健康ごはん', category: '得意な料理ジャンル', sortOrder: 23, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d023', name: '離乳食', category: '得意な料理ジャンル', sortOrder: 24, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d024', name: '幼児食', category: '得意な料理ジャンル', sortOrder: 25, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d038', name: '子ども向けごはん', category: '得意な料理ジャンル', sortOrder: 26, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d025', name: '食育', category: '得意な料理ジャンル', sortOrder: 27, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d026', name: 'アレルギー対応', category: '得意な料理ジャンル', sortOrder: 28, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d027', name: 'おもてなし・パーティー', category: '得意な料理ジャンル', sortOrder: 29, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d028', name: '季節レシピ', category: '得意な料理ジャンル', sortOrder: 30, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d029', name: 'おつまみ', category: '得意な料理ジャンル', sortOrder: 31, active: true, searchVisible: true, createdAt: now, updatedAt: now },
    { id: 'tag_d033', name: 'アウトドア', category: '得意な料理ジャンル', sortOrder: 32, active: true, searchVisible: true, createdAt: now, updatedAt: now },
